...
const triangleTemplate = (letters, backgroundColor, textColor, shapeColor) => {
    return `
  ...
  const circleTemplate = (letters, backgroundColor, textColor, shapeColor) => {
    return `
    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100">
  ...
  const squareTemplate = (letters, backgroundColor, textColor, shapeColor) => {
    return `
    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100">
